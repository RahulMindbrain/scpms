...
const initialNotifications: NotificationItem[] = [
  {
    ...
    message:
      'A high-priority anomaly has been detected in the placement analytics engine. Immediate review is recommended.',
    type: 'SYSTEM_ALERT',
    read: false,
  ...
  },
  {
    ...
    message:
      'A new placement campaign has been successfully launched for final-year students.',
    type: 'DRIVE_CREATED',
    read: false,
  ...
  },
  {
    ...
    message:
      'Student registrations increased by 34% compared to last week.',
    type: 'REGISTRATION',
    read: true,
  ...
  {
    id: 4,
    title: 'Warning: Storage Threshold',
    message:
      'The media storage server has crossed 85% utilization capacity.',
    type: 'WARNING',
    read: true,
            ...
            {filteredNotifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-32 rounded-[3rem] border-2 border-dashed border-border/50 bg-card/50">
                ...
                <p className="text-sm font-bold text-muted-foreground mt-1">
                  No tactical alerts currently synchronized with your feed.
                </p>
              </div>
            ) : (
                  ...
                  return (
                    <motion.div
                      ...
                      className={cn(
                        ...
                        !notification.read
                          ? 'border-indigo-500/50 bg-indigo-50/20 dark:bg-indigo-500/5'
                          : 'bg-card'
                      )}
                    >
                      <div className="p-6 md:p-8">
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm font-bold leading-relaxed max-w-4xl line-clamp-2 text-muted-foreground">
            ...
            >
              <div className="bg-slate-900 p-10 text-white relative">
                <div className="relative z-10">
                  <Badge
                    variant="outline"
                    className="mb-4 bg-white/10 text-white border-white/20 font-black uppercase tracking-widest py-1 px-3"
                  >
              ...
              <div className="p-10 bg-card">
                ...
                <div className="mt-10 flex gap-4">
                  <Button
                    ...
                    className="flex-1 h-14 rounded-2xl font-black uppercase text-[10px] tracking-widest border-border/50"
                  >
                    Close Inspector
                  </Button>
