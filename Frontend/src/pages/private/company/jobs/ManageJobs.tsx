                    ...
                    <tr key={job.id} className="group hover:bg-muted/5 transition-colors">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button className="p-2.5 text-muted-foreground hover:text-emerald-500 hover:bg-emerald-500/10 rounded-xl transition-all" title="Edit Drive">
                            <Edit2 size={18} />
                          </button>
                          <button className="p-2.5 text-muted-foreground hover:text-rose-500 hover:bg-rose-500/10 rounded-xl transition-all" title="Delete Drive">
                            <Trash2 size={18} />
                          </button>
                          <div className="w-px h-4 bg-border mx-1" />
                          <button className="p-2.5 text-primary hover:bg-primary/10 rounded-xl transition-all group/btn" title="View Applicants">
